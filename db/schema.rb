...
ActiveRecord::Schema.define(version: 2021_04_11_123205) do
  ...
  create_table "spree_addresses", id: :serial, force: :cascade do |t|
    ...
    t.integer "user_id"
    t.datetime "deleted_at"
    t.string "nova_poshta_address"
    t.string "nova_poshta_number"
  ...
  create_table "spree_post_translations", force: :cascade do |t|
    t.bigint "spree_post_id", null: false
    t.string "locale", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "title"
    t.string "body"
    t.index ["locale"], name: "index_spree_post_translations_on_locale"
    t.index ["spree_post_id"], name: "index_spree_post_translations_on_spree_post_id"
  end
  ...
  create_table "spree_products", id: :serial, force: :cascade do |t|
    ...
    t.text "related"
    t.boolean "empty_price", default: false
