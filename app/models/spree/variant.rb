module Spree
  class Variant < Spree::Base
    ...
    def price_in(currency, role_id)
      prices.detect { |price| price.currency == currency and price.role_id == role_id } #|| prices.build(currency: currency)
    end

    def amount_in(currency, role_id)
      price_in(currency, role_id).try(:amount)
    end
